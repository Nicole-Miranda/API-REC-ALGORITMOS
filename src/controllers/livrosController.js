...
function cadastrar(req, res) {
    ...
    var quantidade_livros_em_estoque = req.body.quantidade_livros_em_estoque;
    ...
    if (titulo == undefined) {
        ...
        livrosModel.cadastrar(titulo, fkAutor, fkGenero, precoCompra, precoVenda, quantidade_livros_em_estoque)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
